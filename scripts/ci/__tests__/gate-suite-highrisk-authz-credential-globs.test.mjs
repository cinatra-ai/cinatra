...
//   cinatra-ai/ci scripts/truthful-attribution-gate.mjs @bf50cd9533d5f284961cc4760fc21c3fb297902d
...
// config/high-risk-defaults.json @bf50cd9533d5f284961cc4760fc21c3fb297902d).
...
describe("gate-suite highRiskPaths authz/credential/session coverage (2026-08 widening)", () => {
  ...
  it("carries the CalVer the widened glob set shipped under", () => {
    expect(loadSuite().version).toBe("2026.09.3");
  });
});
