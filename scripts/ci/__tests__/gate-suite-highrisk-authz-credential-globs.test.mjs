...
//   cinatra-ai/ci scripts/truthful-attribution-gate.mjs @de121365c22878184fed6e9ae47fadaec43dcf1a
...
// config/high-risk-defaults.json @de121365c22878184fed6e9ae47fadaec43dcf1a).
...
describe("gate-suite highRiskPaths authz/credential/session coverage (2026-08 widening)", () => {
  ...
  it("carries the CalVer the widened glob set shipped under", () => {
    expect(loadSuite().version).toBe("2026.09.2");
  });
});
