...
echo "candidates: REDIS_TAG=${REDIS_TAG:-8-alpine} PG_FROM_TAG=${PG_FROM_TAG:-17-alpine} PG_TO_TAG=${PG_TO_TAG:-17-alpine} NEO4J_TAG=${NEO4J_TAG:-2026.05-community} VERDACCIO_TAG=${VERDACCIO_TAG:-6} PYTHON_TAG=${PYTHON_TAG:-3.14-slim}"
echo ""
