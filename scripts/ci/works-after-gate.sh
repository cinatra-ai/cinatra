...
#   neo4j engine major (upgrade-from):   --arms upgrade-neo4j   NEO4J_FROM_TAG=… NEO4J_TO_TAG=…
#   postgres major (upgrade-from):       --arms upgrade-postgres PG_CASEA_FROM_TAG=… PG_CASEA_TO_TAG=… PG_CASEB_FROM_TAG=… PG_CASEB_TO_TAG=…
