 ...
 * That swap is gated on the operator publishing the contract package per:
 *
 *   scripts/audit/verdaccio-package-publish-bootstrap.md
 *
...
export const CURRENT_ALLOWLIST = Object.freeze([
  ...
  // is still operator-gated (verdaccio-package-publish-bootstrap), so these new
