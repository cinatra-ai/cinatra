...
//
// An extracted extension must reach privileged host capability ONLY through the
...
async function main() {
  ...
  // Fail-closed (source-relocation cutover): the extension source must be cloned back before
