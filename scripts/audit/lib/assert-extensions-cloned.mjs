...
// Fail-closed guard for the extension source-relocation cutover.
//
// After the cutover the extension SOURCE tree is no longer committed to the
// monorepo — it is cloned back from the extracted repos (cinatra-ai/<slug>)
