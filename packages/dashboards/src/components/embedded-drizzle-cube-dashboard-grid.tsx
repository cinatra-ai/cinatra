 ...
 * uses — so an embedded analytics dashboard rendered through `<PortletHost>` is
 * byte-for-byte the live DC grid.
 *
 ...
 *   through a thin app-local re-export lazy-loaded with `next/dynamic`. The
 *   dynamic import keeps the DC client bundle off non-analytics dashboards.
 *
 * Editability:
