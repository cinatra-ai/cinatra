...
export function ReviewerAgentOutputRenderer(props: FieldRendererProps) {
  ...
  // #1796: blog-pipeline's `idea_selection_gate` no longer resolves here. The
  // idea chooser relocated onto its own dedicated binding
  // `@cinatra-ai/blog-pipeline-agent:idea-selection` → BlogIdeaSelectionRenderer
  // (blog-pipeline-agent#40; see blog-idea-selection-renderer.ts). This
  // reviewer-output renderer is a pure content-envelope dispatcher again.
