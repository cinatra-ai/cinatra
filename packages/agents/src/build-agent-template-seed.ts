...
// ---------------------------------------------------------------------------
//
// eng#378 TIER-1: seed the agent_templates row DIRECTLY from the package's
...
//
// Determinism (eng#378 §B2.5): the snapshot and contentHash are derived purely
...
export async function buildAgentTemplateInstallSeed(input: {
  ...
  // Deterministic snapshot. Includes outputSchema + lgGraph* (eng#378 §B2.3,
