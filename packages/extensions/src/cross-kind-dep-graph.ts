...
// uninstall lifecycle callers feed it the installed set. It is the spec §9
// FM-4 mitigation: cross-kind uninstall must never silently delete a
...
/**
 * Block-or-archive on uninstall (FM-4). If any INSTALLED package declares a
