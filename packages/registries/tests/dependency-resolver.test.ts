...
describe("WR-01 regression — stale consumer-range pruning in prefer-newer", () => {
  ...
  //      WITHOUT WR-01 fix: stale edge (A@1.0.0,"^1.0.0") still present →
  //        2.0.0 does NOT satisfy "^1.0.0" → PluginDependencyConflictError (wrong!)
  //      WITH WR-01 fix: stale edge pruned (A is now 1.5.0, not 1.0.0) →
