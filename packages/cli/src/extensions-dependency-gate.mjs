 ...
 * and the portable scripts/extensions/templates/release/release-submit.mjs gate (kept in
 * lock-step). Only these @cinatra-ai/* deps are real marketplace dependencies that
...
export function isRangeSatisfied(range, versions, distTags = {}) {
  ...
  // Extracted repos convert workspace deps to peerDependencies "*"; any
