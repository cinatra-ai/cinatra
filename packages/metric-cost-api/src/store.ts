...
//
// Pure formatters. They live beside the row types rather than in a new module
// of their own: the locked dev-perf routes already reach this file, and a new
// leaf would grow every one of their reachable graphs by one (the route-graph
// ratchet, correctly, refuses that for a pair of string helpers).
//
