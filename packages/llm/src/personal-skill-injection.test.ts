/**
 * EXT-02 assembly contract test for custom skill instruction rendering.
 *
 ...
 *
 * WARNING-3: The external registry mock uses the CORRECT shape:
...
// WARNING-3: CORRECT external registry mock shape.
...
describe("runSkillAwareDeterministicLlmTask — EXT-02 personal skill rendering", () => {
  beforeEach(() => {
    vi.clearAllMocks();
