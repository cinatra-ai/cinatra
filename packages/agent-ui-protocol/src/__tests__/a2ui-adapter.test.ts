...
describe("A2UiAdapter", () => {
  ...
  it("A2UI-05: onRunStarted emits createSurface with surfaceId === runId and catalogId === 'cinatra-default'", async () => {
  ...
  it("A2UI-06: text/tool/resume methods do not call publish", async () => {
    const messages: A2UiMessage[] = [];
