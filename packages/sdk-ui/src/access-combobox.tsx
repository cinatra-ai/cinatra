...
import type { AccessVisibility as AgentAuthPolicyVisibility } from "./lib/access-visibility";
...
export type { AvailableScopes, AccessRowState } from "./access/scope";
...
export { resolveFlatAccessOption } from "./access/scope";
export type {
  FlatAccessOption,
