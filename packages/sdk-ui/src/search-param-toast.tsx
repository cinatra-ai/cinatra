...
// destination with an outcome param (e.g. ?deleted=1 or ?error=<code>); this
// reads it once, shows a STATIC toast, then strips the consumed param so a
// refresh / back-nav doesn't replay it.
//
...
//
// StrictMode / remount safety: a handledKey ref guard makes StrictMode's double
// effect invocation toast once, and a stable toast id dedupes a re-fire if the
// component remounts before router.replace lands.
