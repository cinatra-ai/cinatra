/**
 * cinatra#2825 (S9l) capture lane — produce a REAL review gate through the shipped
 * writers on the running lane stack, so the held card in the conversation has a
 * real gate behind it. PRODUCE -> GATE -> REF only; nothing here decides a gate.
 *
