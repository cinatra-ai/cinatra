...
const BASE = process.argv[2] || "http://localhost:3252";
const OUT = process.argv[3] || "/tmp/s9c-session";
mkdirSync(OUT, { recursive: true });

export const CAPTURE_ACTOR = {
  name: "2853 Typed-Decision Owner",
  username: "typed2853",
  email: "typed-2853@example.com",
  password: "typed-2853-dev-12345",
};
