...
**Neither of the two things the withdrawn round did is done here, and what stands
in each place is stated with its limit rather than promised.** The turn names the
...
**Neither of the two things the withdrawn round did is done here, and that is the
point of the re-shoot.** The deterministic pre-router did not dispatch this run —
