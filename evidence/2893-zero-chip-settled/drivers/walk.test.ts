/**
 * cinatra#2893 zero-chip settled reading — LIVE seeding walk on this lane's own dev stack.
 *
...
const say = (s: string, d: unknown) => console.log(`WALK2893 ${s} ${JSON.stringify(d)}`);
