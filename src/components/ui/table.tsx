...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-10 px-2 text-left align-middle whitespace-nowrap text-muted-foreground font-mono text-[10px] font-bold uppercase tracking-kicker [&:has([role=checkbox])]:pr-0",
        className
      )}
      {...props}
    />
