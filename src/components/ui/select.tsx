  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        position={position}
        // cinatra#3105 — the panel paints ABOVE the sticky app-shell header by
        // design (z-[160] over z-[140]); it must never OCCUPY the header's
        // band. With the default boundary (viewport, no padding) a list taller
        // than the room under its trigger grew straight across the header and
        // hid the breadcrumb and the top-bar control. Bounding the panel here
        // also shrinks --radix-select-content-available-height, so a bounded
        // list scrolls inside itself with every option still reachable.
