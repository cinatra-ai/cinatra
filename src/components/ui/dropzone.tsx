  ...
  ({ className, children, ...props }, forwardedRef) => {
    ...
    return (
      ...
      <div
        ...
        aria-label="dropzone"
        className={cn(
          "flex items-center justify-center rounded-[7px] border border-input bg-surface-strong px-4 py-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
          context.isDragActive && "animate-pulse bg-primary/5",
  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <label
        ...
        {...props}
        className={cn(
          "cursor-pointer rounded-sm bg-transparent px-4 py-2 font-medium ring-offset-background transition-colors focus-within:outline-none hover:bg-transparent has-[input:focus-visible]:ring-2 has-[input:focus-visible]:ring-ring has-[input:focus-visible]:ring-offset-2",
          className,
        )}
      >
        {children}
