...
// The registry cutover readiness gate moved to the pure leaf
// src/lib/agent-run-context-cutover.ts (with the log-stream parser + judge);
// its tests live in src/lib/__tests__/agent-run-context-cutover.test.ts.
