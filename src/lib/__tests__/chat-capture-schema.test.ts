...
import { chatCaptureLedgerDdlSql } from "../../../migrations/core/core__0042_chat-capture-ledger.mjs";

// ---------------------------------------------------------------------------
// Status-vocabulary + DDL sync pins (cinatra#1367): the CHECK constraint in
// the bootstrap leaf, the core__0042 migration, and the TypeScript status
...
describe("chat-capture schema sync", () => {
  ...
  it("core__0042 migration CHECK matches CHAT_CAPTURE_TURN_STATUSES exactly", () => {
