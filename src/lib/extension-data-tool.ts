...
//
// TWO CONDITIONAL OPERATIONS (cinatra#3525). A flow that reserves one row of
...
// conflict target: the host cannot know which unique rule the extension's own
 ...
 * shape a calling extension sees is readable here rather than inferred from a
 * driver's row array.
 */
