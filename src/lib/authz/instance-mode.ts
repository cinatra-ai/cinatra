/**
 * RBAC-UI-03 single-org compatibility mode + RBAC-UI-02
 * nav/tab visibility resolution.
 *
 ...
 *
 * Nav visibility (RBAC-UI-02): a small pure resolver maps a nav/tab target to
 ...
 * regardless of access (RBAC-UI-03). Returns the filtered, ordered list the
 * sidebar renders.
 */
