...
//     migrations/core/core__0026 per the core__0007/core__0024 precedent).
...
// buildCreateStoreSchemaQueries leaf for that one cohesive column group, on the
// same seam idiom as projectInstancesSchemaQueries above and folded in beside
// it rather than given a module of its own, which would add a node to every
// locked route graph that reaches drizzle-store (cinatra#3208 ratchets).
