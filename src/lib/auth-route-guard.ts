...
const PUBLIC_PATH_PREFIXES = [
  ...
  "/api/webhooks/drupal", // Drupal node-publish webhook receiver (drupal-module#72) — auth enforced inside route handler (HMAC-SHA256 over the raw body under the shared drupal_widget_auth.webhookSecret); the byte-for-byte twin of /api/webhooks/wordpress
