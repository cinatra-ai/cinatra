...
END $$` },
    ...
    // dashboard_entity_links — cinatra#1897 B4 scope-collection SECONDARY LISTINGS (additive; mirrors migration core__0078; the canonical home stays the singular entityRef on dashboards, so Overview + name-uniqueness are untouched).
