...
END $$` },
    ...
    // extension_update_read_model (cinatra#1041 outcome 3) — DDL lives in the
    // pure-strings leaf (file-size-ratchet headroom, the #1317/#1405 pattern).
    ...extensionUpdateReadModelSchemaQueries(schemaName),
    // -----------------------------------------------------------------------
