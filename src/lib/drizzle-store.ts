...
END $$` },
    ...
    ...extensionUpdateReadModelSchemaQueries(schemaName), ...skillEfficacySchemaQueries(schemaName), ...connectorInstanceToolPolicySchemaQueries(schemaName), ...connectorInstanceServerSchemaQueries(schemaName), ...connectorInstancePendingCallSchemaQueries(schemaName), ...connectorInstanceConfirmationPolicySchemaQueries(schemaName), ...connectorInstanceNativeInjectionSchemaQueries(schemaName), ...widgetActionCapabilitySchemaQueries(schemaName), // DDL in pure-strings leaves for file-size-ratchet headroom (#1041 outcome-3 / #1317 / #1405 pattern): extension update read-model + cinatra#1368 skill-efficacy exposure telemetry + cinatra#2017 S2 connector_instance_tool_policy + cinatra#2018 S3 connector_instance_server & site_inventory + cinatra#2020 S5 connector_instance_pending_call & confirmation_policy + cinatra#2019 S4 connector_instance_native_injection_policy opt-in (additive bootstrap DDL, no numbered migration; all run late) + cinatra#2575 (epic #2564 S8b) widget_action_capabilities, the request/confirm/consume ledger behind the widget decision path
    // -----------------------------------------------------------------------
