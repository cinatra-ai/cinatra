...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  "agent.assignments.manage": "Assign skills to agents per scope",
  ...
  "context.assign": "Attach context artifacts to agents per scope",
...
export const PERMISSION_SHORT_LABELS: Record<Permission, string> = {
  ...
  "agent.assignments.manage": "Assign",
  "run.read": "View",
  "run.list": "List",
  "run.readData": "Data",
  "run.cancel": "Cancel",
