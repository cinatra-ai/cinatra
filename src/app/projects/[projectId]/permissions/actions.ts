...
// IN-01: `actorFromSession` lives at `@/lib/authz/build-actor-context`.
...
export async function addProjectCoOwnerAction(
  ...
  try {
    ...
    // WR-04: ensure the candidate user is a member of the actor's
...
export async function searchWorkspaceUsersForProject(
  ...
  // WR-05: limit the typeahead to users who are members of the caller's
  ...
  // search. Until projects carry an `organization_id` column (CR-01),
