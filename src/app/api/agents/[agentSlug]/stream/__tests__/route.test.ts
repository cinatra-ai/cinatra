...
// post-#246, a content-editor agent ALSO needs an entry in the host relay table
// (resolveContentEditorRelay). Acme is intentionally NOT in that table, so it
// reaches the relay-resolution step and 500s — documenting the one host-side
// touch-point a new content-editor agent requires.
