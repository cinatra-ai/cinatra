...
export async function POST(req: Request): Promise<Response> {
  ...
  if (wantsMediaInput && dispatch.kind === "dispatch" && body.media) {
    ...
    // MED-3 fast path: trust Content-Length when it's present and finite.
    ...
    // MED-3 stream path: handles missing/untrusted Content-Length.
    ...
    // MED-2: derive the MIME and require it appear in the Gemini allowlist.
