...
// The Artifacts tab of the organization scope (cinatra#2807, per-scope surfaces
...
export default async function OrganizationArtifactsPage({
  params,
}: {
  ...
  return <ScopeSurfacePage scope={{ kind: "organization", id }} tab="artifacts" />;
}
