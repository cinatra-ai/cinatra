...
// The scoped agents tree of the personal scope (cinatra#2809, per-scope
...
export default async function PersonalScopedAgentsRoute({
  params,
  searchParams,
}: {
  ...
  return ScopedAgentsRoute({ scope: { kind: "personal" }, segments: launch, searchParams });
}
