...
export async function generateMetadata({
  ...
  return scopedSurfaceMetadata({ kind: "team", id: teamId }, "Assistants");
}
...
// The scoped assistants tree of the team scope (cinatra#2809, per-scope
...
export default async function TeamScopedAssistantsRoute({
  params,
  searchParams,
}: {
