...
// The scoped agents tree of the workspace scope (cinatra#2809, per-scope
...
export default async function WorkspaceScopedAgentsRoute({
  params,
  searchParams,
}: {
  ...
  return ScopedAgentsRoute({ scope: { kind: "workspace" }, segments: launch, searchParams });
}
