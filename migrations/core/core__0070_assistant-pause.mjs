// core__0070 — installation-wide assistant PAUSE table (cinatra#1880, Epic #1873
...
// core__0069 on origin/main first, so this slice was renumbered to the next
// genuinely-free sequence, core__0070 (a rename-only change, zero SQL diff — the
// additive CREATE TABLE is seq-agnostic). migrations/** is HIGH-RISK: owner
