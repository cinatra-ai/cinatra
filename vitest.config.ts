...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      // Marketplace publish wave runner (pure helpers; no live infra).
      "scripts/marketplace/__tests__/**/*.test.{ts,mjs}",
    ],
    ...
    // structurally-out-of-scope tier or a quarantined sandbox gap, and each is
    // documented in the coverage-gaps notes. Anything NOT excluded here
    ...
    exclude: [
      ...
      // workspace-phantom-deps), NOT as vitest tests.
      ...
      // QUARANTINE (sandbox gap, dated in COVERAGE-GAPS.md): brittle `(\w+)\(\)`
