...
export default defineConfig({
  ...
  test: {
    ...
    // path, S3's connector substrate and S4's row-identity lifecycle share the
    // same isolation reasoning, the same real-Postgres requirement, and the same
    // `pnpm test:install-semantics` entry point.
    include: [
